...
const AreaTooltip = ({ active, payload, label }: any) => {
  ...
  return (
    <div style={{
      ...
      boxShadow: '0 4px 16px rgba(30,27,46,0.10)', fontSize: 13,
    }}>
...
export function AdminDashboard() {
  ...
  return (
    <div className="admin">
        ...
        <div className="chart-card chart-card--full">
          <div className="chart-card__header">
            ...
            <div className="trend-legend">
              <div className="trend-legend__item">
                <div className="trend-legend__dot" style={{ background: '#C4879A' }} />
                Запросы
              </div>
              <div className="trend-legend__item">
                <div className="trend-legend__dot" style={{ background: '#C9A96E' }} />
                Матчи
              </div>
            </div>
          </div>
          ...
          <ResponsiveContainer width="100%" height={200}>
            <AreaChart data={weeklyTrend} margin={{ left: -10, right: 8, top: 4, bottom: 0 }}>
              ...
              <Area type="monotone" dataKey="requests" name="Запросы"
                stroke="#C4879A" strokeWidth={2.5} fill="url(#gradRequests)" dot={false} />
              <Area type="monotone" dataKey="matches"  name="Матчи"
                stroke="#C9A96E" strokeWidth={2.5} fill="url(#gradMatches)"  dot={false} />
            </AreaChart>
          </ResponsiveContainer>
        </div>
      </div>

      {/* Programs + Heatmap side by side */}
      ...
      {/* Новые buddy-запросы (из локального JSON) */}
